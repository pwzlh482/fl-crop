"""
clientCropV2 - Crop 联邦学习优化客户端
基于 client_crop.py 重写，完整适配 PFLlib 框架
...
6. 完整 train_metrics / test_metrics 适配 PFLlib ServerBase 评估逻辑
7. 双模型（ResNet18 + YOLOv8n）训练架构保留并增强
"""
...
from flcore.optimizers.fedoptimizer import PerturbedGradientDescent1
from flcore.clients.clientbase import Client


class clientCropV2(Client):
